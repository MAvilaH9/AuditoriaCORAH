                        ...
                        <form action="../Recursos/Login.php" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group custom-go-button">
                                    <input type="password" name="Contrasenia" id="Contrasenia" class="form-control" placeholder="******" required="" value="" maxlength="40">
                                    <span class="input-group-btn">
										<button class="btn btn-primary " type="button"
											onclick="mostrarContrasena()"><span class="glyphicon glyphicon-eye-close icon"></span>
										</button>
									</span>
                                </div>
