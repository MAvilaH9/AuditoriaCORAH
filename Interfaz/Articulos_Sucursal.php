                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad">
                                            <form id="frmArticulosSuc" class="dropzone dropzone-custom needsclick add-professors">
                                                <div class="row">
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        $(document).on('submit', '#frmArticulosSuc', function (e) {
            e.preventDefault();
            var datos = $('#frmArticulosSuc').val();
            // alert(datos);
            $.ajax({
                type: "Post",
                url: "../Recursos/Articulos.php",
                data: new FormData(this),
                contentType: false,
                processData: false,
                success: function (resp) {
                    // alert(resp);
                    $('#frmArticulosSuc')[0].reset();
                    $('#frmArticulosSuc').hide();
                    $('#Titulo').hide();
                    $('#Resultado').html(resp);
                }
            });
