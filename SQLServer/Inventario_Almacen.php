    ...
    <div class="sparkline13-list">
        ...
        <div class="sparkline13-graph">
            <div class="datatable-dashv1-list custom-datatable-overright" align="right">
                ...
                <a class="btn btn-custon-rounded-two btn-danger external" href="../Interfaz/Inventario_Almacen.php">
    ...
    <div class="sparkline13-list">
        ...
        <div class="sparkline13-graph">
            <div class="datatable-dashv1-list custom-datatable-overright">
                ...
                <a class="btn btn-custon-two btn-primary external" href="../Interfaz/Inventario_Almacen.php">
                    <i class="fa fa-angle-left edu-icon edu-down-arrow" aria-hidden="true"></i>
                    Regresar 
                </a>
            </div>
