    ...
    <div class="sparkline13-list">
        ...
        <div class="sparkline13-graph">
            <div class="datatable-dashv1-list custom-datatable-overright" align="right">
                ...
                <a class="btn btn-default align:center external" href="../SQLServer/ExcVentas.php?Sucursal=<?php echo $sucursal;?>" title="Exportar excel"><i
                ...
                <a class="btn btn-custon-rounded-two btn-danger external" href="../Interfaz/Ventas_Sucursal.php">
    ...
    <div class="sparkline13-list">
        ...
        <div class="sparkline13-graph">
            <div class="datatable-dashv1-list custom-datatable-overright">
                ...
                <a class="btn btn-custon-two btn-primary external" href="../Interfaz/Ventas_Sucursal.php">
                    <i class="fa fa-angle-left edu-icon edu-down-arrow" aria-hidden="true"></i>
                    Regresar 
                </a>
            </div>
